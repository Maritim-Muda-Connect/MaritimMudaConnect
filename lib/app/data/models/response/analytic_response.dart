...
AnalyticResponse analyticResponseFromJson(String str) =>
    AnalyticResponse.fromJson(json.decode(str));

String analyticResponseToJson(AnalyticResponse data) =>
...
class AnalyticResponse {
  ...
  factory AnalyticResponse.fromJson(Map<String, dynamic> json) =>
      AnalyticResponse(
        ...
        widgets: json["widgets"] == null
            ? []
            : List<Widgets>.from(
                json["widgets"]!.map((x) => Widgets.fromJson(x))),
        months: json["months"] == null
            ? []
            : List<String>.from(json["months"]!.map((x) => x)),
        userCounts: Map.from(json["userCounts"]!)
  ...
  Map<String, dynamic> toJson() => {
        ...
        "widgets": widgets == null
            ? []
            : List<dynamic>.from(widgets!.map((x) => x.toJson())),
        "months":
            months == null ? [] : List<dynamic>.from(months!.map((x) => x)),
        "userCounts": Map.from(userCounts!)
