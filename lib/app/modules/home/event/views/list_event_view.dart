              ...
              if (controller.isLoading.value) {
                ...
                return Column(
                  children: controller.filterEventList.map((events){
                    final String startDate = DateFormat('dd/MM/yyyy').format(events.startDate!);
                    return InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                      ...
                      child: Padding(
                        ...
                        child: ProgramCard(
                          ...
                          textSubTitle: "",
                          onShare: () {
                            Share.share("Check this out: \n${events.externalUrl ?? "Sorry, this event does not have a URL available!"}" , subject: "Event Url");
                          },
                        ),
                      ),
                    );
