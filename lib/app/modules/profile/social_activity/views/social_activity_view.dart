                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                  ...
                                  onTap: () {
                                    if (controller.validateForm()) {
                                      if (controller.isEdit.value) {
                                        SocialActivityRequest request =
                                            SocialActivityRequest(
                                          name:
                                              controller.programController.text,
                                ...
                                ProfileButton(
                                  icon:
                                      Icon(Icons.close, color: neutral01Color),
                            ...
                            Obx(
                              () => Column(
                                children: controller.socialActivityLists
                                    .map((activity) {
                                  return Padding(
                                    padding:
                                    ...
                                    child: ProfileCard(
                                      ...
                                      onTap2: () => showCustomDialog(
                                          ...
                                          onConfirm: () {
                                            controller.deleteSocialAcitivty(
                                                activity.id!);
