...
// LIGHT TEXT
TextStyle lightText10 = GoogleFonts.poppins(fontSize: 10, fontWeight: reguler);
TextStyle lightText12 = GoogleFonts.poppins(fontSize: 12, fontWeight: reguler);
...
// SEMIBOLD TEXT
TextStyle semiBoldText8 =
    GoogleFonts.poppins(fontSize: 8, fontWeight: semiBold);
TextStyle semiBoldText11 =
    GoogleFonts.poppins(fontSize: 11, fontWeight: semiBold);
...
// EXTRABOLD TEXT
TextStyle extraBoldText20 =
    GoogleFonts.poppins(fontSize: 20, fontWeight: extraBold);
